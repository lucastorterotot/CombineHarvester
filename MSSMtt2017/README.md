...
ggH
```
combineTool.py -m "100,110,120,130,140,180,200,250,300,400,450,600,700,800,900,1200,1400,1500,2300,2600,2900,3200" -M Asymptotic --rAbsAcc 0 --rRelAcc 0.0005 --setParameters r_ggH=0,r_bbH=0 --redefineSignalPOIs r_ggH -d output/mssm_tt/tt/ws.root --there -n ".ggH" --parallel 25

combineTool.py -M CollectLimits output/mssm_tt/*/higgsCombine.ggH*.root --use-dirs -o "mssm_ggH.json"

python ../MSSMFull2016/scripts/plotMSSMLimits.py --logy --logx mssm_ggH_tt.json --cms-sub="Preliminary" -o mssm_tt_ggH --process 'gg#phi' --title-right="41.5 fb^{-1}" --title-left="#tau_{h}#tau_{h}" --show 'exp' --plot-exp-points
```
bbH
```
combineTool.py -m "100,110,120,130,140,180,200,250,300,400,450,600,700,800,900,1200,1400,1500,2300,2600,2900,3200" -M Asymptotic --rAbsAcc 0 --rRelAcc 0.0005 --setParameters r_ggH=0,r_bbH=0 --redefineSignalPOIs r_bbH -d output/mssm_tt/tt/ws.root --there -n ".bbH" --parallel 25

combineTool.py -M CollectLimits output/mssm_tt/*/higgsCombine.bbH*.root --use-dirs -o "mssm_bbH.json"

python ../MSSMFull2016/scripts/plotMSSMLimits.py --logy --logx mssm_bbH_tt.json --cms-sub="Preliminary" -o mssm_tt_bbH --process 'bb#phi' --title-right="41.5 fb^{-1}" --title-left="#tau_{h}#tau_{h}" --show 'exp' --plot-exp-points
```
...
```
MorphingMSSM2017 --real_data=false
...
combineTool.py -M AsymptoticGrid ~/Combine/MSSM2016/CMSSW_7_4_7/src/CombineHarvester/MSSMFull2016/scripts/mssm_asymptotic_grid_mhmodp.json -d output/mssm_tt/tt/mhmodp.root --parallel 30
```