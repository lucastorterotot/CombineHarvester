...
do
    ...
    python $CMSSW_BASE/src/CombineHarvester/MSSMFull2016/scripts/plotMSSMLimits.py --logy --logx mssm_${p}H_mt.json -o mssm_mt_${p}H --process "${p}#phi" --title-right="41.5 fb^{-1}" --title-left="#mu#tau_{h}" --show "exp" --plot-exp-points --use-hig-17-020-style --y-axis-max 1000 --y-axis-min .001
done
